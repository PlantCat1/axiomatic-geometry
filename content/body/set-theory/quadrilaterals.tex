...
\[
\square ABCD \coloneq AB \cup BC \cup CD \cup DA.
\]
...
\begin{theorem}
    ...
    \angle BAC \cong \angle DAC \text{ and } \angle BCA \cong \angle DCA.
    \]
Every element of L is a subset of P
\end{theorem}
\begin{proof}
    Consider the triangles $\triangle ABC$ and $\triangle ADC$.
    \begin{itemize}
...
11.15.3 Harmonic quadrilaterals (vertices form a harmonic division on the circumcircle – requires cross-ratio, so likely beyond current primitives)
